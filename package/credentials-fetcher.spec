...
BuildRequires:  cmake3 make chrpath openldap-devel grpc-devel gcc-c++ glib2-devel boost-devel openssl-devel zlib-devel protobuf-devel re2-devel krb5-devel systemd-devel systemd-rpm-macros

Requires: bind-utils openldap openldap-clients grpc-cli
